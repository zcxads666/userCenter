export default {
  ...
  'pages.register.username.placeholder': '请输入注册账号',
  'pages.login.username.required': '账号是必填项！',
  'pages.login.username.length': '账号长度必须大于3！',
  'pages.login.password.placeholder': '请输入登录密码',
  'pages.register.password.placeholder': '请输入注册密码',
  'pages.register.checkpassword.placeholder': '请再次输入注册密码',
  'pages.login.password.required': '密码是必填项！',
  'pages.login.checkpassword.required': '核对密码是必填项！',
